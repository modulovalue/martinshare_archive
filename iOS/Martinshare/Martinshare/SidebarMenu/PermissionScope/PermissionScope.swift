...
@objc open class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    open var permissionLabelColor:UIColor = .black()
            ...
            statusForPermission(type,
                completion: { currentStatus in
                    ...
                    if currentStatus == .authorized {
                        ...
                        button.setTitle("Erlaube \(prettyDescription)".localized.uppercased(), for: UIControlState())
                    } else if currentStatus == .unauthorized {
                        self.setButtonUnauthorizedStyle(button)
                        button.setTitle("\(prettyDescription) abgelehnt".localized.uppercased(), for: UIControlState())
                    } else if currentStatus == .disabled {
                        //                setButtonDisabledStyle(button)
                        button.setTitle("\(prettyDescription) deaktiviert".localized.uppercased(), for: UIControlState())
                    }
    ...
    */
    func permissionStyledButton(_ type: PermissionType) -> UIButton {
        ...
        case .locationAlways, .locationInUse:
            button.setTitle("Aktiviere \(type.prettyDescription)".localized.uppercased(), for: UIControlState())
        default:
            button.setTitle("Erlaube \(type.prettyDescription)".localized.uppercased(), for: UIControlState())
        }
    ...
    */
    func showDeniedAlert(_ permission: PermissionType) {
        ...
        let alert = UIAlertController(title: "Erlaubnis für \(permission.prettyDescription) wurde nicht erteilt.".localized,
            message: "Bitte erlaube \(permission.prettyDescription) in den Einstellungen".localized,
            preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: "OK".localized,
            style: .cancel,
            handler: nil))
        alert.addAction(UIAlertAction(title: "Anzeigen".localized,
            style: .default,
            handler: { action in
    ...
    */
    func showDisabledAlert(_ permission: PermissionType) {
        ...
        let alert = UIAlertController(title: "\(permission.prettyDescription) sind Deaktiviert.".localized,
            message: "Bitte erlaube \(permission.prettyDescription) in den Einstellungen".localized,
            preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: "OK".localized,
            style: .cancel,
