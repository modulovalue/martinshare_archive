            ...
            body
{
    ...
    top:-8px;
    left:-8px;">  
    <a href="https://www.martinshare.com"><img style="max-width:150px; 
        position: absolute;
        margin: auto;
        top: 0px;
        left: 0;
        right: 0;
        " src="https://www.martinshare.com/images/logomartinshare.png"></a>
    </div>
    
    <div style="padding: 15px;">
        
        <h2 style="text-align:center;"><strong>Datenschutzerklärung</strong></h2><p><strong>Geltungsbereich</strong></p><p>Diese Datenschutzerklärung klärt Nutzer über die Art, den Umfang und Zwecke der Erhebung und Verwendung personenbezogener Daten durch den verantwortlichen Anbieter 
            <p>Modestas Valauskas<br>
            Westring 23<br>
            76437 Rastatt<br>
            <br>
            Telefon: +4917642603080<br>
            E-Mail: info@martinshare.com<br>
            </p>
        ...
        <br />
        Die im Rahmen von Google Analytics von Ihrem Browser übermittelte IP-Adresse wird nicht mit anderen Daten von Google zusammengeführt. Die Nutzer können die Speicherung der Cookies durch eine entsprechende Einstellung Ihrer Browser-Software verhindern; Dieses Angebot weist die Nutzer jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich werden nutzen können.<br />
        <br />
